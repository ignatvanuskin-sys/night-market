...
export default function Home() {
  ...
  const filtered = useMemo(() => {
    ...
    const result = products.filter((p) => {
      const matchesQuery = !normalized || [p.title, p.category, ...p.tags, styleMap[p.id], themeMap[p.id]].join(" ").toLowerCase().includes(normalized);
